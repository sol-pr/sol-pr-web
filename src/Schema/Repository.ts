export class GithubRepo {
    ...
    constructor(fields: { id: string; repo_url: string; repo_name: string; repo_description: string; is_active: number; total_pull_requests: bigint; pull_request_limit: bigint; reward_per_pull_request: bigint; owner_wallet_address: Uint8Array; repo_wallet_address: Uint8Array; } | undefined = undefined) {
        if (fields) {
            this.id = fields.id;
